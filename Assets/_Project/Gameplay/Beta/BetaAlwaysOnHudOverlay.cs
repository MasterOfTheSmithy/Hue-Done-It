...
namespace HueDoneIt.Gameplay.Beta
{
    ...
    public sealed class BetaAlwaysOnHudOverlay : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            if (GameObject.Find("GameplayRuntimeHudCanvas") != null ||
                GameObject.Find("GameplayHudRoot") != null ||
                FindFirstObjectByType<HueDoneIt.UI.Gameplay.GameplayInvestorHud>() != null)
            {
                return;
            }
